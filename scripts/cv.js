...
async function loadEducationInfo() {
  let response = await fetch("/cv_doc/education.json"); 
...
async function loadProjectInfo() {
  let response = await fetch("/cv_doc/projects.json"); 
  let jsonFile = await response.json(); 
...
async function loadCWInfo() {
  let response = await fetch("/cv_doc/coursework.json"); 
  let jsonFile = await response.json(); 
...
async function loadSkillInfo() {
  let response = await fetch("/cv_doc/skills.json"); 
  let jsonFile = await response.json(); 
